  ...
  <div class="v-page-wrapper wh-100 flex-column" id="v-page">
    <div v-if="rows && cols" class="v-page" :style="{width: pageW + 'px', height: pageH + 'px'}">
      ...
      <div class="v-page-grid-layout wh-100">
        ...
        />
        <FlexLayout v-else-if="type == 'flex'" :row-height="itemH" :col-width="itemW" @layout-change="onLayoutChange"/>
        <MoveableLayout v-else :row-height="itemH" :col-width="itemW" :page-rows="pageRows"/>
      </div>
...
import MoveableLayout from './moveable-layout/index.vue'
